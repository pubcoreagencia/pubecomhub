        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="w-full lg:w-[400px] shrink-0">
            <div className="sticky top-40 space-y-6">
              ...
              <Link to="/store" className="flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-slate-900 transition-colors">
