      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
             ...
             <div className="h-8 w-8 rounded-full bg-blue-600 flex items-center justify-center text-white">{React.createElement(Megaphone, { className: "h-4 w-4" })}</div>
          </CardHeader>
        ...
        <CardContent>
           <div className="p-4 border border-dashed rounded-lg bg-slate-50 flex items-center justify-between">
              <div className="flex items-center gap-3">
                 <div className="p-2 bg-primary/10 rounded-md">{React.createElement(Target, { className: "h-4 w-4 text-primary" })}</div>
                 <div>
