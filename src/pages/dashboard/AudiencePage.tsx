...
import { UserPlus, ShoppingCart, CreditCard, UserCheck } from "lucide-react";
      ...
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[var(--hub-muted)] font-black uppercase tracking-widest text-[10px]">
              Gestão Inteligente de Públicos e Remarketing
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {levels.map((l, i) => (
            <div
              key={i}
              className="hub-card hub-gradient-border p-8 flex items-center justify-between group"
            >
              <div className="flex items-center gap-6">
                ...
                <div>
                  <p className="text-[9px] font-black uppercase tracking-widest text-[var(--hub-muted)] opacity-60">
                    Nível {l.level}
                  </p>
