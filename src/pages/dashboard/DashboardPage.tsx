            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="hub-card hub-gradient-border p-6 h-[300px] flex flex-col">
                ...
                <div className="flex-1 space-y-4">
                  {stats?.stats.sources &&
                    Object.entries(stats.stats.sources).map(([source, data]) => (
                  ...
                  {(!stats || Object.keys(stats.stats.sources).length === 0) && (
                    <div className="text-[10px] text-[var(--hub-muted)] italic">
              ...
              <div className="hub-card hub-gradient-border p-6 h-[300px] flex flex-col">
                ...
                <div className="flex-1 space-y-3 pt-2">
                  {[
                    ...
                    {
                      label: "Processando",
                      val: stats?.stats.sync.running || 0,
                      color: "bg-blue-500",
                    },
                    {
                      label: "Parcial",
                      val: stats?.stats.sync.partial || 0,
                      color: "bg-yellow-500",
                    },
                    ...
                    <div key={s.label} className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-[var(--hub-muted)] w-24">
                        {s.label}
                      </span>
                      <div className="flex-1 h-1 bg-black/40 rounded-full overflow-hidden">
                        <div
                          className={cn("h-full", s.color)}
                          style={{ width: `${(s.val / (stats?.stats.sync.success || 1)) * 100}%` }}
                        />
                      </div>
          ...
          <div className="space-y-8">
            ...
            <div className="hub-card hub-gradient-border p-6 flex flex-col min-h-[450px]">
              ...
              <div className="space-y-4">
                {[
                  {
                    msg: "Stats Recarregados",
                    type: "API",
                    time: "agora",
                    meta: "Backend Official",
                  },
                  ...
                  <div
                    key={i}
                    className="hub-glass p-4 rounded-xl border border-[var(--hub-border)] space-y-2 hover:border-[var(--hub-primary)] transition-all cursor-pointer"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[9px] text-[var(--hub-muted)] font-bold italic">
                        {evt.time}
                      </span>
                    </div>
                    ...
                    <p className="text-[9px] text-[var(--hub-muted)] font-bold uppercase tracking-widest opacity-40">
                      {evt.meta}
                    </p>
                  </div>
                ))}
