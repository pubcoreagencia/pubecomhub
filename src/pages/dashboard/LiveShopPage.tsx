          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="hub-card hub-gradient-border p-6 flex items-center justify-between">
                <div>
                  <p className="text-[9px] font-black uppercase tracking-widest text-[var(--hub-muted)]">
                    Ticket Médio
                  </p>
            ...
            <div className="hub-card hub-gradient-border p-6 h-[660px] flex flex-col">
              ...
              <div className="flex-1 space-y-4 overflow-y-auto pr-2 no-scrollbar">
                {[
                  {
                    type: "SALE",
                    msg: "Venda Aprovada #10942",
                    time: "2s",
                    meta: "Trend Store · @carlos_ads",
                  },
                  {
                    type: "CHECKOUT",
                    msg: "Checkout Iniciado",
                    time: "14s",
                    meta: "Electro Hub · Smartwatch X",
                  },
                  {
                    type: "CART",
                    msg: "Item no Carrinho",
                    time: "26s",
                    meta: "Trend Store · Headphones Pro",
                  },
                  {
                    type: "SALE",
                    msg: "Venda Aprovada #10941",
                    time: "45s",
                    meta: "Electro Hub · Charger MagSafe",
                  },
                  {
                    type: "PENDING",
                    msg: "PIX Aguardando",
                    time: "1m",
                    meta: "Trend Store · Case Leather",
                  },
                  {
                    type: "SALE",
                    msg: "Venda Aprovada #10940",
                    time: "2m",
                    meta: "Trend Store · Wireless Mouse",
                  },
                ].map((evt, i) => (
                  <div
                    key={i}
                    className="hub-glass p-4 rounded-xl border border-[var(--hub-border)] hover:border-[var(--hub-primary)]/40 transition-all"
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-[9px] text-[var(--hub-muted)] font-black italic">
                        {evt.time}
                      </span>
                    </div>
                    <p className="text-[11px] font-black text-white italic leading-tight">
                      {evt.msg}
                    </p>
                    <p className="text-[9px] text-[var(--hub-muted)] font-bold uppercase tracking-widest mt-1 opacity-50">
                      {evt.meta}
                    </p>
                  </div>
                ))}
